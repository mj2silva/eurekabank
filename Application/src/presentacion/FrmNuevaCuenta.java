...
public class FrmNuevaCuenta extends javax.swing.JFrame {
    ...
    /**
     * Creates new form FrmNuevaCuenta
     */
    public FrmNuevaCuenta(Cliente cliente, Persona usuario) {
        initComponents();
        this.usuario = usuario;
        this.cliente = cliente;
        cbxMoneda.removeAllItems();
        cbxMoneda.addItem("Soles");
        cbxMoneda.addItem("Dolares");
    }
    ...
    private void initComponents() {
        ...
        txtNroCuenta = new javax.swing.JTextPane();
        ...
        jLabel2.setText("Monto de apertura");

        jLabel3.setText("Tipo de moneda");

        jScrollPane1.setViewportView(txtNroCuenta);
    ...
    private void btnCrearCuentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearCuentaActionPerformed
        // TODO add your handling code here:
        String numeroDeCuenta = txtNroCuenta.getText();
        Double montoD = Double.valueOf(txtMonto.getText());
        BigDecimal monto = BigDecimal.valueOf(montoD);
    ...
    private javax.swing.JTextPane txtNroCuenta;
